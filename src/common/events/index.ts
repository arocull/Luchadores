...
export interface IPlayerConnectResponse extends events.IPlayerConnectResponse {
  type: TypeEnum.PlayerConnectResponse,
}
  export interface IWorldNew extends events.IWorldNew {
